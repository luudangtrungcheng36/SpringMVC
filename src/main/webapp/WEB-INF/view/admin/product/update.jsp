                        ...
                        <main>
                            ...
                            <div class="d-flex justify-content-center align-items-center vh-100 container">
                                <div class="col-md-8 col-lg-6">
                                    ...
                                    <form:form class="row g-3" action="/admin/product/update/${updateProduct.id}"
                                        ...
                                        <div class="col-12">
                                            <img src="/images/products/${updateProduct.image}"
                                                style="max-height: 250px;" alt="product preview" id="productPreview">
                                        </div>
